...
export const AbuseOfDominantPositionByProhibition_URL = `${API_BASE_URL}/abuseofdominantpositionsbyprohibitions`;
export const AbuseOfDominantPositionByInvestigation_URL = `${API_BASE_URL}/abuseofdominantpositionsbyprohibitions`;
